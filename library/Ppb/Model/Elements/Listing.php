    ...
    public function getElements()
    {
        ...
        $elements = array(
            ...
            array(
                ...
                'subform'     => 'details',
                'id'          => 'image',
                'element'     => ($settings['images_max'] > 0) ? ((in_array('fees_calculator', $this->_formId)) ? 'text' : '\\Ppb\\Form\\Element\\MultiUpload\\Sortable') : false,
                'label'       => $this->_('Images'),
            ...
            array(
                'form_id'     => array('global', 'fees_calculator'),
                'subform'     => 'details',
                'id'          => 'video',
                'element'     => ($settings['videos_max'] > 0) ? ((in_array('fees_calculator', $this->_formId)) ? 'text' : '\\Ppb\\Form\\Element\\MultiUpload') : false,
                'label'       => $this->_('Media'),
