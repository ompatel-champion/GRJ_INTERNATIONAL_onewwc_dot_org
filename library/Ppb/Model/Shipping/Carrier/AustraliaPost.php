...
class AustraliaPost extends AbstractCarrier
{
    ...
    /**
     *
     * carrier weight uom (override)
     *
     * @var string
     */
    protected static $_carrierWeightUom = ShippingModel::UOM_KG;

    /**
     *
     * carrier dimensions uom (override)
     *
     * @var string
     */
    protected static $_carrierDimensionsUom = ShippingModel::UOM_CM;
    ...
    {
        parent::__construct(self::NAME, self::CURRENCY);
    ...
    /**
     *
     * get Australia Post setup form elements
     *
     * @return array
     */
