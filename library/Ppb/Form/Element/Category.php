...
class Category extends Element
{
    ...
    public function __construct($name)
    {
        ...
        $this->setBodyCode(
            ...
            . "     var categoriesDisplay = el.find('.btn-category').attr('data-categories-display'); " . "\n"
            . "     $.post( " . "\n"
    ...
    public function render()
    {
        ...
        $output = $this->getPrefix() . ' '
            ...
            . $this->_endTag
            . '<button class="btn btn-primary btn-category mb-1" '
            . $this->renderAttributes() . '>'
            . (($categoryName === null) ? $translate->_('Select Category') : $categoryName)
            . '</button> '
            . '<span data-feather="x" class="btn-category-cancel" style="display: '
            . (($categoryName === null) ? 'none' : 'inline-block') . '"></span>'
            . $this->getSuffix()
