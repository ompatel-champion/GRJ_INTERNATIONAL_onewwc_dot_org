...
use Ppb\Db\Table\StoresSubscriptions as StoresSubscriptionsTable,
    Members\View\Helper\StoreSubscription as StoreSubscriptionHelper;
...
class StoresSubscriptions extends AbstractServiceTable
{
    ...
    public function getMultiOptions()
    {
        ...
        $storeSubscriptionHelper = new StoreSubscriptionHelper();

        $subscriptions = $this->fetchAll();

        foreach ($subscriptions as $subscription) {
            /** @var \Ppb\Db\Table\Row\StoreSubscription $subscription */
            $data[$subscription['id']] = array(
                $translate->_($subscription['name']),
                $storeSubscriptionHelper->storeSubscription($subscription)->description()
            );
        }
