...
class Session
{
     ...
     * @var bool
     */
    protected $_cookieHttpOnly = true;
     ...
     * @2.0 - by default, cookies will be saved as http only
     *
    ...
    public function setCookie($key, $value, $path = null)
    {
        ...
        setcookie($key, $value, $expirationDate, $path, '', $this->isCookieSecure(), $this->isCookieHttpOnly());
