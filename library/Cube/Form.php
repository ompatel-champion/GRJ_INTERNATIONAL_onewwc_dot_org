...
class Form
{
     ...
     * if displaying the async form on a page, this
     * flag is true on first display, then on form post it becomes false
     *
     * @var bool
     */
    protected $_asyncWrapper = false;
    ...
    /**
     *
     * redirect parent for async forms
     *
     * @var bool
     */
    protected $_redirectParent = false;
    ...
    public function setAsync($async = true)
    {
        ...
        if ($async === true) {
            $asyncElement = new Element\Hidden(self::ELEMENT_ASYNC);
            $asyncElement->setValue(1);
            $this->addElement($asyncElement);
        }
        else {
            $this->removeElement(self::ELEMENT_ASYNC);
        }
    ...
    /**
     *
     * get async wrapper flag
     *
     * @return bool
     */
    public function isAsyncWrapper()
    {
    ...
    /**
     *
     * set async wrapper flag
     *
     * @param bool $asyncWrapper
     *
     * @return $this
     */
    public function setAsyncWrapper($asyncWrapper = true)
    {
        $this->_asyncWrapper = $asyncWrapper;
    ...
    /**
     *
     * check redirect parent flag
     *
     * @return bool
     */
    public function isRedirectParent()
    {
        return $this->_redirectParent;
    }

    /**
     *
     * set redirect parent flag
     *
     * @param bool $redirectParent
     *
     * @return $this
     */
    public function setRedirectParent($redirectParent = true)
    {
        $this->_redirectParent = $redirectParent;
