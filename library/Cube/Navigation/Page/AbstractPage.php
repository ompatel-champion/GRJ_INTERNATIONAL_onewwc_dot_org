...
abstract class AbstractPage extends AbstractContainer
{
     ...
     * @param array $options
     *
     * @return \Cube\Navigation\Page\AbstractPage|bool
...
////                        create a page object, provided: %s.", serialize($options)));
    ...
    /**
     *
     * set page order to use in parent container
     *
     * @param  int $order page order in container.
     *
     * @return $this
     */
    ...
    /**
     * to string magic method, returns page label
     *
     * @return string
     */
