...
class Tools extends AbstractAction
{
    ...
    {
        $this->_forward('history', 'account', 'members');
    }
    ...
    public function MessagingCreate()
    {
        $this->_forward('create', 'messaging', 'members');
    }
    ...
    {
        $this->_forward('index', 'settings', null, array('page' => 'postmen'));
    }
}