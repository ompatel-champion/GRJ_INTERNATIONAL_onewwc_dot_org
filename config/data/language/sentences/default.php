...
// Cube\Validate\Password
_("'%s' does not meet the strength requirements: %settings%.");
_('at least %value% characters');
_('no spaces');
...
_("'%s': the value '%value%' is invalid.");
// Ppb\Validate\FlatRatesPostage
// Ppb\Validate\ItemPostage
_("'%s': the price fields only accept numeric values.");
// Ppb\Validate\LocalizedNumeric
_("'%s' must contain a localized numeric value.");
// Ppb\Validate\MultipleEmails
_("'%s' must contain one or multiple valid email addresses.");
_("'%s': you cannot enter an email address more than once.");
// Ppb\Validate\ReCaptcha
_("The reCAPTCHA code is incorrect.");
// Ppb\Validate\StockLevels
_("'%s': the quantity fields only accept positive integer values.");
// Ppb\Validate\VatNumber
_("'%s': '%value%' is not a valid VAT number.");
// Cube\Validate\Different
_("'%s' and '%name%' must have different values.");

// @version 8.0
// Ppb/Db/Table/Row/ContentEntry.php
_('Standard');
_('Multiple / Post');
// Ppb/Db/Table/Row/ContentSection.php
_('Single');
_('Multiple');
_('Tree');

// Ppb\Service\Listings
_("%s listing has been opened.");
_("%s listing has been closed.");
_("%s listing has been relisted.");
_("%s listing has been activated.");
_("%s listing has been suspended.");
_("%s listing has been approved.");
_("%s listing has been undeleted.");
_("%s listing has been deleted.");

// Ppb\Service\Users
_("%s user account has been activated.");
_("%s user account has been suspended.");
_("%s user account has been approved.");
_("%s user account has had its email addresses verified.");
_("%s user account has been deleted.");

// Ppb\Service\Sales
_("%s invoice has been activated.");
_("%s invoice has been combined.");
_("%s invoice has been undeleted.");
_("%s invoice has been deleted.");

// App/View/Helper/Social.php
_("Facebook");
_("Twitter");
_("LinkedIn");
_("Instagram");
...
// @version 8.1
_('Admin Balance Adjustment - User ID: #%s');
_('Admin Balance Adjustment - User ID: #%s - Comment: %s');

// @version 8.2
_("Relevance");
_("Lowest Price First");
_("Highest Price First");
